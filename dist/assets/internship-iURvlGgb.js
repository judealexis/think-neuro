import{S as x,i as q,s as B,g as L,h as D,j as f,b as R,l as G,t as b,k as U,o as z,d as w,e as N,p as K,x as F,q as M,a as E,c as _,u,y as P,A as j,v as g,B as H,m as C,w as W,f as I,C as Q,H as J,R as X,F as V,n as Y}from"./SmartText-1xXAdcIL.js";import{T as Z}from"./TextButton-G5aVTk7r.js";import{C as ee}from"./Carousel-OWvRHApt.js";function O(s,i,n){const r=s.slice();return r[7]=i[n],r}function $(s){let i,n,r=s[7].title+"",d,l,t,c,e,o,a,T,k,m,v,A,p;return v=new F({props:{text:s[7].body}}),{c(){i=f("div"),n=f("div"),d=M(r),l=E(),t=f("div"),c=f("div"),e=f("img"),k=E(),m=f("div"),_(v.$$.fragment),A=E(),u(n,"id","header"),u(n,"class","svelte-1qbi7g"),u(e,"id","cardImage"),P(e.src,o=(s[3]>500?"assets/projects/":"assets/projects/stretched/")+s[7].image)||u(e,"src",o),u(e,"alt",a=s[7].title),u(e,"class","svelte-1qbi7g"),u(c,"id","imageWrapper"),u(c,"class","svelte-1qbi7g"),L(()=>s[5].call(c)),u(m,"id","textDisc"),u(m,"class","inColumn svelte-1qbi7g"),j(m,"max-height",s[1]+"px"),u(t,"id","holder"),u(t,"class","inRow svelte-1qbi7g"),u(i,"id","card"),u(i,"class","inColumn svelte-1qbi7g")},m(h,y){R(h,i,y),g(i,n),g(n,d),g(i,l),g(i,t),g(t,c),g(c,e),T=H(c,s[5].bind(c)),g(t,k),g(t,m),C(v,m,null),s[6](m),g(i,A),p=!0},p(h,y){(!p||y&1)&&r!==(r=h[7].title+"")&&W(d,r),(!p||y&9&&!P(e.src,o=(h[3]>500?"assets/projects/":"assets/projects/stretched/")+h[7].image))&&u(e,"src",o),(!p||y&1&&a!==(a=h[7].title))&&u(e,"alt",a);const S={};y&1&&(S.text=h[7].body),v.$set(S),(!p||y&2)&&j(m,"max-height",h[1]+"px")},i(h){p||(b(v.$$.fragment,h),p=!0)},o(h){w(v.$$.fragment,h),p=!1},d(h){h&&N(i),T(),I(v),s[6](null)}}}function te(s){let i,n,r,d;L(s[4]);let l=D(s[0]),t=[];for(let e=0;e<l.length;e+=1)t[e]=$(O(s,l,e));const c=e=>w(t[e],1,1,()=>{t[e]=null});return{c(){i=f("main");for(let e=0;e<t.length;e+=1)t[e].c()},m(e,o){R(e,i,o);for(let a=0;a<t.length;a+=1)t[a]&&t[a].m(i,null);n=!0,r||(d=G(window,"resize",s[4]),r=!0)},p(e,[o]){if(o&15){l=D(e[0]);let a;for(a=0;a<l.length;a+=1){const T=O(e,l,a);t[a]?(t[a].p(T,o),b(t[a],1)):(t[a]=$(T),t[a].c(),b(t[a],1),t[a].m(i,null))}for(U(),a=l.length;a<t.length;a+=1)c(a);z()}},i(e){if(!n){for(let o=0;o<l.length;o+=1)b(t[o]);n=!0}},o(e){t=t.filter(Boolean);for(let o=0;o<t.length;o+=1)w(t[o]);n=!1},d(e){e&&N(i),K(t,e),r=!1,d()}}}function ie(s,i,n){let r,{prop:d=[]}=i,l,t;function c(){n(3,r=window.innerWidth)}function e(){l=this.clientHeight,n(1,l)}function o(a){Q[a?"unshift":"push"](()=>{t=a,n(2,t)})}return s.$$set=a=>{"prop"in a&&n(0,d=a.prop)},n(3,r=0),[d,l,t,r,c,e,o]}class ae extends x{constructor(i){super(),q(this,i,ie,te,B,{prop:0})}}function ne(s){let i,n,r,d,l,t,c;return n=new J({}),d=new X({props:{children:[{title:"PROJECTS",orientation:"left",component:Z,prop:["ThinkNeuro offers research-based internships with topics encompassing health technology, health education, and health policy. Accepted interns are able to choose the rotation of their choice.",!0,"click","Apply","https://docs.google.com/forms/d/e/1FAIpQLSfaGQGwgbRma6smf8XtuUar6PQIvSa9xd2zKc3uz2E1s5u1gg/viewform"]},{title:"CURRENT OPPORTUNITIES",orientation:"left",component:ae,prop:s[0]},{title:"STUDENT TESTIMONIALS",orientation:"center",component:ee,prop:[4,"assets/testimonials/internship/"]}]}}),t=new V({}),{c(){i=f("main"),_(n.$$.fragment),r=E(),_(d.$$.fragment),l=E(),_(t.$$.fragment)},m(e,o){R(e,i,o),C(n,i,null),g(i,r),C(d,i,null),g(i,l),C(t,i,null),c=!0},p:Y,i(e){c||(b(n.$$.fragment,e),b(d.$$.fragment,e),b(t.$$.fragment,e),c=!0)},o(e){w(n.$$.fragment,e),w(d.$$.fragment,e),w(t.$$.fragment,e),c=!1},d(e){e&&N(i),I(n),I(d),I(t)}}}function se(s){return[[{image:"opioid.jpg",title:"Opioid Education Outreach in San Bernardino",body:`
      τBACKGROUNDΤ
      ...
      Λ`},{image:"inter.jpg",title:"Digital Intervention Platform for Opioid Addiction",body:`
      τBACKGROUNDΤ
      ...
      Λ`},{image:"advo.jpg",title:"Policy Advocacy for Substance Abuse Treatment",body:`
      τBACKGROUNDΤ 
      Recognizing the entrenched systemic barriers hindering access to substance abuse treatment, 
      there is an urgent need for policy changes that enhance both affordability and accessibility. ρ Ρ 
      
      τDESCRIPTIONΤ 
      Embark on a dynamic policy advocacy project dedicated to improving substance abuse treatment accessibility. 
      Key tasks encompass: 
      λ 
      πεPolicy Analysis:ΕThoroughly research and analyze existing state and federal policies pertaining to substance 
      abuse treatment, identifying critical areas for enhancement.Π
      πεStakeholder Engagement:ΕEstablish collaborative partnerships by reaching out to advocacy groups, healthcare professionals, 
      and policymakers, creating a robust coalition supporting enhanced accessibility.Π 
      πεLegislative Recommendations:ΕCraft tangible and actionable legislative recommendations aimed at addressing identified 
      gaps within substance abuse treatment policy.Π 
      πεCommunity Awareness Campaign:ΕSpearhead the creation of impactful materials and events designed to raise awareness 
      about the significance of policy changes, fostering community support for this crucial initiative.Π 
      Λ

      τINTERN ENGAGEMENTΤ
      λ 
      πεResearch:ΕFostering a deep understanding of the policy landscape and identifying potential areas for improvement, ultimately 
      equipped with the knowledge essential for effective advocacy.Π
      πεCommunication:ΕDeveloping and implementing effective communication strategies. This involves forging connections with advocacy 
      ...
      amplifying the advocacy message.Π 
      πεCommunity engagement:ΕLeverage unique skills to create materials and organize events that resonate with diverse audiences. 
      Interns become ambassadors, engaging communities and driving awareness about the importance of policy changes.Π
      Λ`},{image:"tele.jpg",title:"Telehealth Expansion for Addiction Treatment",body:`
      τBACKGROUNDΤ
      The Telehealth Expansion for Addiction Treatment project stems from a critical need to address 
      ...
      create significant hurdles for individuals seeking addiction treatment. ρ Ρ 
      
      τDESCRIPTIONΤ 
      Develop and implement a project to expand telehealth services for addiction treatment, including: 
      λ 
      πεNeeds Assessment:ΕIdentify regions with limited access to addiction treatment services and assess their telehealth infrastructure.Π
      πεPartnerships:ΕCollaborate with healthcare providers, insurers, and telehealth platforms to establish and promote telehealth services 
      for addiction treatment.Π 
      πεUser-Friendly Resources:ΕCreate educational materials to guide individuals through the process of accessing addiction treatment through 
      telehealth.Π 
      πεResearch, Outreach, and Resource Development:ΕInvolved in multifaceted roles, encompassing thorough research, targeted outreach efforts, 
      ...
      addressing unique challenges in rural or underserved areas.Π 
      ...
      Λ`}]]}class oe extends x{constructor(i){super(),q(this,i,se,ne,B,{})}}new oe({target:document.body,props:{name:"world"}});
