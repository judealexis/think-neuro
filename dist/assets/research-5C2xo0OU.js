import{S as $,i as A,s as N,g as G,h as b,j as f,b as g,l as K,t as d,k as B,o as C,d as m,e as y,p as U,a as S,u as p,v,D as P,c as _,r as J,m as I,f as k,y as R,n as E,x as Y,z as W,H as Q,R as V,F as Z}from"./SmartText-CJq4Eywl.js";/* empty css                                                 */import{T as x}from"./TextAlone-9ghW9nvh.js";import{T as X}from"./TextButton-frcb696F.js";/* empty css                                               *//* empty css                                                */import{A as ee}from"./Accordian-dVvdPvJ1.js";import{C as te}from"./CtaBtn-xMPwMLJP.js";function M(c,e,r){const n=c.slice();return n[7]=e[r],n}function H(c,e,r){const n=c.slice();return n[10]=e[r],n}function q(c){let e,r,n;var i=c[10].component;function h(t,a){return{props:{props:t[10].args}}}return i&&(e=P(i,h(c))),{c(){e&&_(e.$$.fragment),r=J()},m(t,a){e&&I(e,t,a),g(t,r,a),n=!0},p(t,a){if(a&2&&i!==(i=t[10].component)){if(e){B();const s=e;m(s.$$.fragment,1,0,()=>{k(s,1)}),C()}i?(e=P(i,h(t)),_(e.$$.fragment),d(e.$$.fragment,1),I(e,r.parentNode,r)):e=null}else if(i){const s={};a&2&&(s.props=t[10].args),e.$set(s)}},i(t){n||(e&&d(e.$$.fragment,t),n=!0)},o(t){e&&m(e.$$.fragment,t),n=!1},d(t){t&&y(r),e&&k(e,t)}}}function j(c){let e,r,n,i,h=b(c[7]),t=[];for(let s=0;s<h.length;s+=1)t[s]=q(H(c,h,s));const a=s=>m(t[s],1,1,()=>{t[s]=null});return{c(){e=f("div");for(let s=0;s<t.length;s+=1)t[s].c();r=S(),p(e,"id",n=c[0]<680?"centered":""),p(e,"class","inRow svelte-19yjjpk")},m(s,l){g(s,e,l);for(let o=0;o<t.length;o+=1)t[o]&&t[o].m(e,null);v(e,r),i=!0},p(s,l){if(l&2){h=b(s[7]);let o;for(o=0;o<h.length;o+=1){const u=H(s,h,o);t[o]?(t[o].p(u,l),d(t[o],1)):(t[o]=q(u),t[o].c(),d(t[o],1),t[o].m(e,r))}for(B(),o=h.length;o<t.length;o+=1)a(o);C()}(!i||l&1&&n!==(n=s[0]<680?"centered":""))&&p(e,"id",n)},i(s){if(!i){for(let l=0;l<h.length;l+=1)d(t[l]);i=!0}},o(s){t=t.filter(Boolean);for(let l=0;l<t.length;l+=1)m(t[l]);i=!1},d(s){s&&y(e),U(t,s)}}}function ne(c){let e,r,n,i;G(c[4]);let h=b(c[1]),t=[];for(let s=0;s<h.length;s+=1)t[s]=j(M(c,h,s));const a=s=>m(t[s],1,1,()=>{t[s]=null});return{c(){e=f("main");for(let s=0;s<t.length;s+=1)t[s].c()},m(s,l){g(s,e,l);for(let o=0;o<t.length;o+=1)t[o]&&t[o].m(e,null);r=!0,n||(i=K(window,"resize",c[4]),n=!0)},p(s,[l]){if(l&3){h=b(s[1]);let o;for(o=0;o<h.length;o+=1){const u=M(s,h,o);t[o]?(t[o].p(u,l),d(t[o],1)):(t[o]=j(u),t[o].c(),d(t[o],1),t[o].m(e,null))}for(B(),o=h.length;o<t.length;o+=1)a(o);C()}},i(s){if(!r){for(let l=0;l<h.length;l+=1)d(t[l]);r=!0}},o(s){t=t.filter(Boolean);for(let l=0;l<t.length;l+=1)m(t[l]);r=!1},d(s){s&&y(e),U(t,s),n=!1,i()}}}function re(c,e,r){let n,{prop:i}=e,h=!0;try{h=i[0].three}catch{}let t=[],a=[];function s(o){r(1,t=[]),console.log(t);for(let u=0;u<i.length;u++)a.push(i[u]),(a.length==o||i.length-u<o)&&(t.push(a),a=[])}function l(){r(0,n=window.innerWidth)}return c.$$set=o=>{"prop"in o&&r(2,i=o.prop)},c.$$.update=()=>{c.$$.dirty&9&&s(n>1050&&h?3:n>680?2:1)},r(0,n=0),[n,t,i,h,l]}class ie extends ${constructor(e){super(),A(this,e,re,ne,N,{prop:2})}}function oe(c){let e,r;return{c(){e=f("img"),p(e,"id","img"),p(e,"alt","poster"),R(e.src,r=c[0])||p(e,"src",r),p(e,"class","svelte-1rwxzh2")},m(n,i){g(n,e,i)},p(n,[i]){i&1&&!R(e.src,r=n[0])&&p(e,"src",r)},i:E,o:E,d(n){n&&y(e)}}}function ae(c,e,r){let{props:n}=e;return c.$$set=i=>{"props"in i&&r(0,n=i.props)},[n]}class T extends ${constructor(e){super(),A(this,e,ae,oe,N,{props:0})}}function z(c,e,r){const n=c.slice();return n[2]=e[r][0],n[3]=e[r][1],n[4]=e[r][2],n[6]=r,n}function L(c,e,r){const n=c.slice();return n[7]=e[r],n}function se(c){let e,r,n;return{c(){e=f("div"),r=f("img"),p(r,"id","txtImg"),R(r.src,n=c[2][0])||p(r,"src",n),p(r,"alt","illustration"),p(r,"class","image svelte-5vu8td"),p(e,"class","imageGroup svelte-5vu8td")},m(i,h){g(i,e,h),v(e,r)},p(i,h){h&1&&!R(r.src,n=i[2][0])&&p(r,"src",n)},d(i){i&&y(e)}}}function le(c){let e,r=b(c[2]),n=[];for(let i=0;i<r.length;i+=1)n[i]=F(L(c,r,i));return{c(){e=f("div");for(let i=0;i<n.length;i+=1)n[i].c();p(e,"class","imageGroupMulti svelte-5vu8td")},m(i,h){g(i,e,h);for(let t=0;t<n.length;t+=1)n[t]&&n[t].m(e,null)},p(i,h){if(h&1){r=b(i[2]);let t;for(t=0;t<r.length;t+=1){const a=L(i,r,t);n[t]?n[t].p(a,h):(n[t]=F(a),n[t].c(),n[t].m(e,null))}for(;t<n.length;t+=1)n[t].d(1);n.length=r.length}},d(i){i&&y(e),U(n,i)}}}function F(c){let e,r;return{c(){e=f("img"),p(e,"id","txtImg"),R(e.src,r=c[7])||p(e,"src",r),p(e,"alt","illustration"),p(e,"class","image svelte-5vu8td")},m(n,i){g(n,e,i)},p(n,i){i&1&&!R(e.src,r=n[7])&&p(e,"src",r)},d(n){n&&y(e)}}}function D(c){let e,r,n,i,h,t,a;function s(u,w){return u[2].length>1?le:se}let l=s(c),o=l(c);return i=new Y({props:{text:c[3]}}),{c(){e=f("main"),o.c(),r=S(),n=f("div"),_(i.$$.fragment),h=S(),p(n,"class","textHolder svelte-5vu8td"),p(e,"class",t=W("textImageHolder "+c[4])+" svelte-5vu8td"),p(e,"key",c[6])},m(u,w){g(u,e,w),o.m(e,null),v(e,r),v(e,n),I(i,n,null),v(e,h),a=!0},p(u,w){l===(l=s(u))&&o?o.p(u,w):(o.d(1),o=l(u),o&&(o.c(),o.m(e,r)));const O={};w&1&&(O.text=u[3]),i.$set(O),(!a||w&1&&t!==(t=W("textImageHolder "+u[4])+" svelte-5vu8td"))&&p(e,"class",t)},i(u){a||(d(i.$$.fragment,u),a=!0)},o(u){m(i.$$.fragment,u),a=!1},d(u){u&&y(e),o.d(),k(i)}}}function ce(c){let e,r,n,i,h;n=new Y({props:{text:c[1]}});let t=b(c[0]),a=[];for(let l=0;l<t.length;l+=1)a[l]=D(z(c,t,l));const s=l=>m(a[l],1,1,()=>{a[l]=null});return{c(){e=f("main"),r=f("div"),_(n.$$.fragment),i=S();for(let l=0;l<a.length;l+=1)a[l].c();p(r,"class","textHolderIntro svelte-5vu8td"),p(e,"class","textImgListCont svelte-5vu8td")},m(l,o){g(l,e,o),v(e,r),I(n,r,null),v(e,i);for(let u=0;u<a.length;u+=1)a[u]&&a[u].m(e,null);h=!0},p(l,[o]){if(o&1){t=b(l[0]);let u;for(u=0;u<t.length;u+=1){const w=z(l,t,u);a[u]?(a[u].p(w,o),d(a[u],1)):(a[u]=D(w),a[u].c(),d(a[u],1),a[u].m(e,null))}for(B(),u=t.length;u<a.length;u+=1)s(u);C()}},i(l){if(!h){d(n.$$.fragment,l);for(let o=0;o<t.length;o+=1)d(a[o]);h=!0}},o(l){m(n.$$.fragment,l),a=a.filter(Boolean);for(let o=0;o<a.length;o+=1)m(a[o]);h=!1},d(l){l&&y(e),k(n),U(a,l)}}}function he(c,e,r){let{prop:n}=e,i=n.shift();return c.$$set=h=>{"prop"in h&&r(0,n=h.prop)},[n,i]}class ue extends ${constructor(e){super(),A(this,e,he,ce,N,{prop:0})}}function pe(c){let e,r,n,i,h,t;return e=new Q({}),n=new V({props:{children:[{title:"BRI: BIBLIOMETRICS RESEARCH INTERNSHIP",orientation:"left",component:X,prop:[`
        ...
        `,!0,"click","Apply","https://tinyurl.com/thinkneuro-fa25"]},{component:x,title:"ELIGIBILITY & APPLICATION CRITERIA",prop:[`
        ...
        `,"left"]},{component:x,title:"INSIDE THE BRI CURRICULUM",prop:[`
        ...
        `,"left"]},{component:x,title:"TOOLS & PLATFORMS YOU'LL LEARN",prop:[`
        ...
        `,"left"]},{component:x,title:"THINKNEURO AI SUITE",prop:[`
        ...
        `,"left"]},{component:ue,title:"INTERN OUTCOMES",prop:["Every student’s journey into research looks a little different. Hear directly from past interns about how BRI shaped their academic goals, built their confidence, and opened new doors whether they were just starting out in high school or diving deeper as undergraduates. These stories offer a glimpse into what's possible through the program.",[["assets/research/intern_outcomes/1.png"],`
        ...
        ▶️ φhttps://www.youtube.com/shorts/iBE7y8VjDNoθWatch his story hereΦ.
          `,"left"],[["assets/research/intern_outcomes/2.png"],`
        ...
        ▶️ φhttps://www.youtube.com/shorts/-4y6MUDtWt8θWatch her story here.Φ
          `,"left"],[["assets/research/intern_outcomes/3.png","assets/research/intern_outcomes/4.png","assets/research/intern_outcomes/5.png","assets/research/intern_outcomes/6.png"],`
     εFour Undergraduate Voices, One JourneyΕ ρ Ρ
        ...
        ▶️ φhttps://youtube.com/shorts/QoSe3Fc0UMcθWatch their stories here.Φ
          `,"left"],[["assets/research/intern_outcomes/7.png"],`
     εSonia SinghalΕ ρ Ρ
        ...
        ▶️ φhttps://www.youtube.com/watch?v=404HAt-ww3M&list=PL7yaNuHOf2USqfJUnt7CV8xs0A1PtthdKθWatch the full series hereΦ.
          `,"left"]]},{component:ie,title:"PAST INTERNS",prop:[{component:T,args:"assets/research/past_intern/1.png"},{component:T,args:"assets/research/past_intern/2.png"},{component:T,args:"assets/research/past_intern/3.png"},{component:T,args:"assets/research/past_intern/4.png"},{component:T,args:"assets/research/past_intern/5.png"},{component:T,args:"assets/research/past_intern/6.png"}]},{component:te,title:"",prop:["ωApply Now for the Fall 2025 CohortΩ","Start Your Application","https://tinyurl.com/thinkneuro-fa25"]},{title:"FREQUENTLY ASKED QUESTIONS",orientation:"left",component:ee,prop:[{question:"How much time should I expect to commit each week?",answer:`Interns typically spend ε3–5 hours per weekΕ, depending on their pace and depth of exploration. 
          ...
          `,isOpen:!1}]}]}}),h=new Z({}),{c(){_(e.$$.fragment),r=S(),_(n.$$.fragment),i=S(),_(h.$$.fragment)},m(a,s){I(e,a,s),g(a,r,s),I(n,a,s),g(a,i,s),I(h,a,s),t=!0},p:E,i(a){t||(d(e.$$.fragment,a),d(n.$$.fragment,a),d(h.$$.fragment,a),t=!0)},o(a){m(e.$$.fragment,a),m(n.$$.fragment,a),m(h.$$.fragment,a),t=!1},d(a){a&&(y(r),y(i)),k(e,a),k(n,a),k(h,a)}}}class de extends ${constructor(e){super(),A(this,e,null,pe,N,{})}}new de({target:document.body,props:{name:"world"}});
