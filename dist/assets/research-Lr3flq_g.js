import{S as N,i as B,s as q,g as V,h as b,j as w,b as m,l as Q,t as f,k as S,o as $,d as y,e as g,p as R,a as k,u as d,v as E,D as W,c as v,r as J,m as _,f as I,y as x,n as C,x as U,z as P,H as Z,R as X,F as ee}from"./SmartText-CJq4Eywl.js";/* empty css                                                 */import{T as A}from"./TextAlone-9ghW9nvh.js";import{T as te}from"./TextButton-frcb696F.js";/* empty css                                               *//* empty css                                                */import{A as ne}from"./Accordian-dVvdPvJ1.js";import{C as re}from"./CtaBtn-xMPwMLJP.js";function H(c,t,o){const r=c.slice();return r[7]=t[o],r}function M(c,t,o){const r=c.slice();return r[10]=t[o],r}function j(c){let t,o,r;var s=c[10].component;function h(i,a){return{props:{props:i[10].args}}}return s&&(t=W(s,h(c))),{c(){t&&v(t.$$.fragment),o=J()},m(i,a){t&&_(t,i,a),m(i,o,a),r=!0},p(i,a){if(a&2&&s!==(s=i[10].component)){if(t){S();const e=t;y(e.$$.fragment,1,0,()=>{I(e,1)}),$()}s?(t=W(s,h(i)),v(t.$$.fragment),f(t.$$.fragment,1),_(t,o.parentNode,o)):t=null}else if(s){const e={};a&2&&(e.props=i[10].args),t.$set(e)}},i(i){r||(t&&f(t.$$.fragment,i),r=!0)},o(i){t&&y(t.$$.fragment,i),r=!1},d(i){i&&g(o),t&&I(t,i)}}}function z(c){let t,o,r,s,h=b(c[7]),i=[];for(let e=0;e<h.length;e+=1)i[e]=j(M(c,h,e));const a=e=>y(i[e],1,1,()=>{i[e]=null});return{c(){t=w("div");for(let e=0;e<i.length;e+=1)i[e].c();o=k(),d(t,"id",r=c[0]<680?"centered":""),d(t,"class","inRow svelte-19yjjpk")},m(e,u){m(e,t,u);for(let n=0;n<i.length;n+=1)i[n]&&i[n].m(t,null);E(t,o),s=!0},p(e,u){if(u&2){h=b(e[7]);let n;for(n=0;n<h.length;n+=1){const l=M(e,h,n);i[n]?(i[n].p(l,u),f(i[n],1)):(i[n]=j(l),i[n].c(),f(i[n],1),i[n].m(t,o))}for(S(),n=h.length;n<i.length;n+=1)a(n);$()}(!s||u&1&&r!==(r=e[0]<680?"centered":""))&&d(t,"id",r)},i(e){if(!s){for(let u=0;u<h.length;u+=1)f(i[u]);s=!0}},o(e){i=i.filter(Boolean);for(let u=0;u<i.length;u+=1)y(i[u]);s=!1},d(e){e&&g(t),R(i,e)}}}function ie(c){let t,o,r,s;V(c[4]);let h=b(c[1]),i=[];for(let e=0;e<h.length;e+=1)i[e]=z(H(c,h,e));const a=e=>y(i[e],1,1,()=>{i[e]=null});return{c(){t=w("main");for(let e=0;e<i.length;e+=1)i[e].c()},m(e,u){m(e,t,u);for(let n=0;n<i.length;n+=1)i[n]&&i[n].m(t,null);o=!0,r||(s=Q(window,"resize",c[4]),r=!0)},p(e,[u]){if(u&3){h=b(e[1]);let n;for(n=0;n<h.length;n+=1){const l=H(e,h,n);i[n]?(i[n].p(l,u),f(i[n],1)):(i[n]=z(l),i[n].c(),f(i[n],1),i[n].m(t,null))}for(S(),n=h.length;n<i.length;n+=1)a(n);$()}},i(e){if(!o){for(let u=0;u<h.length;u+=1)f(i[u]);o=!0}},o(e){i=i.filter(Boolean);for(let u=0;u<i.length;u+=1)y(i[u]);o=!1},d(e){e&&g(t),R(i,e),r=!1,s()}}}function oe(c,t,o){let r,{prop:s}=t,h=!0;try{h=s[0].three}catch{}let i=[],a=[];function e(n){o(1,i=[]),console.log(i);for(let l=0;l<s.length;l++)a.push(s[l]),(a.length==n||s.length-l<n)&&(i.push(a),a=[])}function u(){o(0,r=window.innerWidth)}return c.$$set=n=>{"prop"in n&&o(2,s=n.prop)},c.$$.update=()=>{c.$$.dirty&9&&e(r>1050&&h?3:r>680?2:1)},o(0,r=0),[r,i,s,h,u]}class ae extends N{constructor(t){super(),B(this,t,oe,ie,q,{prop:2})}}function se(c){let t,o;return{c(){t=w("img"),d(t,"id","img"),d(t,"alt","poster"),x(t.src,o=c[0])||d(t,"src",o),d(t,"class","svelte-1rwxzh2")},m(r,s){m(r,t,s)},p(r,[s]){s&1&&!x(t.src,o=r[0])&&d(t,"src",o)},i:C,o:C,d(r){r&&g(t)}}}function le(c,t,o){let{props:r}=t;return c.$$set=s=>{"props"in s&&o(0,r=s.props)},[r]}class T extends N{constructor(t){super(),B(this,t,le,se,q,{props:0})}}function L(c,t,o){const r=c.slice();return r[2]=t[o][0],r[3]=t[o][1],r[4]=t[o][2],r[6]=o,r}function F(c,t,o){const r=c.slice();return r[7]=t[o],r}function D(c,t,o){const r=c.slice();return r[7]=t[o],r}function ce(c){let t,o,r,s,h;o=new U({props:{text:c[3]}});let i=b(c[2]),a=[];for(let e=0;e<i.length;e+=1)a[e]=Y(F(c,i,e));return{c(){t=w("div"),v(o.$$.fragment),r=k(),s=w("div");for(let e=0;e<a.length;e+=1)a[e].c();d(t,"class","textHolder svelte-qhp97x"),d(s,"class","imageGroup svelte-qhp97x")},m(e,u){m(e,t,u),_(o,t,null),m(e,r,u),m(e,s,u);for(let n=0;n<a.length;n+=1)a[n]&&a[n].m(s,null);h=!0},p(e,u){const n={};if(u&1&&(n.text=e[3]),o.$set(n),u&1){i=b(e[2]);let l;for(l=0;l<i.length;l+=1){const p=F(e,i,l);a[l]?a[l].p(p,u):(a[l]=Y(p),a[l].c(),a[l].m(s,null))}for(;l<a.length;l+=1)a[l].d(1);a.length=i.length}},i(e){h||(f(o.$$.fragment,e),h=!0)},o(e){y(o.$$.fragment,e),h=!1},d(e){e&&(g(t),g(r),g(s)),I(o),R(a,e)}}}function he(c){let t,o,r,s,h,i=b(c[2]),a=[];for(let e=0;e<i.length;e+=1)a[e]=G(D(c,i,e));return s=new U({props:{text:c[3]}}),{c(){t=w("div");for(let e=0;e<a.length;e+=1)a[e].c();o=k(),r=w("div"),v(s.$$.fragment),d(t,"class","imageGroup svelte-qhp97x"),d(r,"class","textHolder svelte-qhp97x")},m(e,u){m(e,t,u);for(let n=0;n<a.length;n+=1)a[n]&&a[n].m(t,null);m(e,o,u),m(e,r,u),_(s,r,null),h=!0},p(e,u){if(u&1){i=b(e[2]);let l;for(l=0;l<i.length;l+=1){const p=D(e,i,l);a[l]?a[l].p(p,u):(a[l]=G(p),a[l].c(),a[l].m(t,null))}for(;l<a.length;l+=1)a[l].d(1);a.length=i.length}const n={};u&1&&(n.text=e[3]),s.$set(n)},i(e){h||(f(s.$$.fragment,e),h=!0)},o(e){y(s.$$.fragment,e),h=!1},d(e){e&&(g(t),g(o),g(r)),R(a,e),I(s)}}}function Y(c){let t,o;return{c(){t=w("img"),x(t.src,o=c[7])||d(t,"src",o),d(t,"alt","illustration"),d(t,"class","image svelte-qhp97x")},m(r,s){m(r,t,s)},p(r,s){s&1&&!x(t.src,o=r[7])&&d(t,"src",o)},d(r){r&&g(t)}}}function G(c){let t,o;return{c(){t=w("img"),x(t.src,o=c[7])||d(t,"src",o),d(t,"alt","illustration"),d(t,"class","image svelte-qhp97x")},m(r,s){m(r,t,s)},p(r,s){s&1&&!x(t.src,o=r[7])&&d(t,"src",o)},d(r){r&&g(t)}}}function K(c){let t,o,r,s,h,i;const a=[he,ce],e=[];function u(n,l){return n[4]==="left"?0:1}return o=u(c),r=e[o]=a[o](c),{c(){t=w("main"),r.c(),s=k(),d(t,"class",h=P("mainHolder "+c[4])+" svelte-qhp97x"),d(t,"key",c[6])},m(n,l){m(n,t,l),e[o].m(t,null),E(t,s),i=!0},p(n,l){let p=o;o=u(n),o===p?e[o].p(n,l):(S(),y(e[p],1,1,()=>{e[p]=null}),$(),r=e[o],r?r.p(n,l):(r=e[o]=a[o](n),r.c()),f(r,1),r.m(t,s)),(!i||l&1&&h!==(h=P("mainHolder "+n[4])+" svelte-qhp97x"))&&d(t,"class",h)},i(n){i||(f(r),i=!0)},o(n){y(r),i=!1},d(n){n&&g(t),e[o].d()}}}function ue(c){let t,o,r,s,h,i;r=new U({props:{text:c[1]}});let a=b(c[0]),e=[];for(let n=0;n<a.length;n+=1)e[n]=K(L(c,a,n));const u=n=>y(e[n],1,1,()=>{e[n]=null});return{c(){t=w("main"),o=w("div"),v(r.$$.fragment),s=k();for(let n=0;n<e.length;n+=1)e[n].c();h=J(),d(o,"class","textHolderIntro svelte-qhp97x"),d(t,"class","mainHolderIntro svelte-qhp97x")},m(n,l){m(n,t,l),E(t,o),_(r,o,null),m(n,s,l);for(let p=0;p<e.length;p+=1)e[p]&&e[p].m(n,l);m(n,h,l),i=!0},p(n,[l]){if(l&1){a=b(n[0]);let p;for(p=0;p<a.length;p+=1){const O=L(n,a,p);e[p]?(e[p].p(O,l),f(e[p],1)):(e[p]=K(O),e[p].c(),f(e[p],1),e[p].m(h.parentNode,h))}for(S(),p=a.length;p<e.length;p+=1)u(p);$()}},i(n){if(!i){f(r.$$.fragment,n);for(let l=0;l<a.length;l+=1)f(e[l]);i=!0}},o(n){y(r.$$.fragment,n),e=e.filter(Boolean);for(let l=0;l<e.length;l+=1)y(e[l]);i=!1},d(n){n&&(g(t),g(s),g(h)),I(r),R(e,n)}}}function pe(c,t,o){let{prop:r}=t,s=r.shift();return c.$$set=h=>{"prop"in h&&o(0,r=h.prop)},[r,s]}class de extends N{constructor(t){super(),B(this,t,pe,ue,q,{prop:0})}}function fe(c){let t,o,r,s,h,i;return t=new Z({}),r=new X({props:{children:[{title:"BRI: BIBLIOMETRICS RESEARCH INTERNSHIP",orientation:"left",component:te,prop:[`
     ...
     εSonia SinghalΕ ρ Ρ
        ...
        ▶️ φhttps://www.youtube.com/watch?v=404HAt-ww3M&list=PL7yaNuHOf2USqfJUnt7CV8xs0A1PtthdKθWatch the full series hereΦ.
          `,"right"]]},{component:ae,title:"PAST INTERNS",prop:[{component:T,args:"assets/research/past_intern/1.png"},{component:T,args:"assets/research/past_intern/2.png"},{component:T,args:"assets/research/past_intern/3.png"},{component:T,args:"assets/research/past_intern/4.png"},{component:T,args:"assets/research/past_intern/5.png"},{component:T,args:"assets/research/past_intern/6.png"}]},{component:re,title:"",prop:["ωApply Now for the Fall 2025 CohortΩ","Start Your Application","https://tinyurl.com/thinkneuro-fa25"]},{title:"FREQUENTLY ASKED QUESTIONS",orientation:"left",component:ne,prop:[{question:"How much time should I expect to commit each week?",answer:`Interns typically spend ε3–5 hours per weekΕ, depending on their pace and depth of exploration. 
          ...
          `,isOpen:!1}]}]}}),h=new ee({}),{c(){v(t.$$.fragment),o=k(),v(r.$$.fragment),s=k(),v(h.$$.fragment)},m(a,e){_(t,a,e),m(a,o,e),_(r,a,e),m(a,s,e),_(h,a,e),i=!0},p:C,i(a){i||(f(t.$$.fragment,a),f(r.$$.fragment,a),f(h.$$.fragment,a),i=!0)},o(a){y(t.$$.fragment,a),y(r.$$.fragment,a),y(h.$$.fragment,a),i=!1},d(a){a&&(g(o),g(s)),I(t,a),I(r,a),I(h,a)}}}class me extends N{constructor(t){super(),B(this,t,null,fe,q,{})}}new me({target:document.body,props:{name:"world"}});
