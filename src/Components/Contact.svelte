...
<main id="bigHolder">
  ...
  <div class="inColumn">
    ...
    <a id="contact" class="inRow" href="mailto:info@thinkneuro.org">
      <svg
        id="contactIcon"
        width={viewWidth > 800 ? "15px" : "11px"}
        height={viewWidth > 800 ? "15px" : "14px"}
        viewBox="0 0 40 20"
        version="1.1"
      ...
      >
        ...
        >
          <g
            ...
            transform="translate(-414.000000, -261.000000) scale(1,1)"
            fill="#007BFF"
          >
            <path
    ...
    >
      <svg
        ...
        height={viewWidth > 800 ? "20px" : "14px"}
        viewBox="0 0 40 20"
        version="1.1"
    ...
    <a id="contact" class="inRow" href="http://youtube.com/@ThinkNeuroUSA">
      <svg
        ...
        height={viewWidth > 800 ? "18px" : "11px"}
        viewBox="0 -3 20 20"
        version="1.1"
        xmlns="http://www.w3.org/2000/svg"
        xmlns:xlink="http://www.w3.org/1999/xlink"
